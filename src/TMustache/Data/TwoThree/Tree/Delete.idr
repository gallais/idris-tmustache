...
delete k lk ku (Node2 k1 v1 l r) with (compareBy ltR k k1)
  | LT kk1 with (delete k lk (LTLift kk1) l)
  ...
  | EQ kk1 with (append l r)
    | ItFits lr          = TooSmall lr
    | TooBig k' v' l' r' = SameSize (Node2 k' v' l' r')
  | GT k1k with (delete k (LTLift k1k) ku r)
...
delete k lk ku (Node3 k1 v1 k2 v2 l m r) with (compareBy ltR k k1)
  | LT kk1 with (delete k lk (LTLift kk1) l)
